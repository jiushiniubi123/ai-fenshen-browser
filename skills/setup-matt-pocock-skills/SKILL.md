...
description: "为此仓库配置 engineering skills——设置其 issue tracker、triage labels 词汇与 domain docs 布局。适用于首次在某个仓库中使用 engineering skills 之前，或用户要求重新配置 issue tracker、triage labels 与 docs 目录时。"
---
