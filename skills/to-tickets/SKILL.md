---
name: to-tickets
description: "把 plan、spec 或当前对话拆成一组 tracer-bullet tickets，每个 ticket 声明 blocking edges，并发布到已配置的 tracker；本地用每 ticket 一个文件中的文本 edge，真实 tracker 用 native blocking links。适用于用户想把计划或 spec 拆成可执行 tickets，或要求“break this into tickets”时。"
---
