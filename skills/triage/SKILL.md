---
name: triage
description: "让 issues 和 external PRs 通过一组 triage roles 状态机——分类、验证、必要时 grilling，并写出 agent-ready briefs。适用于用户想 triage 一批 issues 或外部 PR、要求整理 backlog，或需要把原始 bug report 变成 agent-ready issue 时。"
---
